    ...
    <form class="form-horizontal" role="form" method="POST" action="/signup">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-login"></i></div>
                ...
                <div class="form-control-feedback">
                        <span class="text-danger align-middle">
                            <c:if test="${error_map != null}">
                                <c:if test="${error_map['error_login_email'] !=null}">
                                    <i class="fa fa-close"><c:out value="${error_map['error_login_email']}"/></i>
                                </c:if>
                            </c:if>
                        </span>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-control-feedback">
                        <span class="text-danger align-middle">
                            <!-- Put phone validation error messages here -->
                        </span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <button type="submit" class="btn btn-dark" style="width: 100%; margin-left: 4%;"><i class="fa fa-user-plus"></i> Register</button>
            </div>
        </div>
    </form>
</div>
